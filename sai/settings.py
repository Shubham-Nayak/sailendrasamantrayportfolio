...
SECRET_KEY = '53k*s*#b*g0%+-)q#@2h9iezn$1s2r(_xr+a9ev0ue9a46n*n+'
...
#STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'sai/static'),
]
...
DEFAULT_FILE_STORAGE = 'sai.storage_backends.MediaStorage'  # <-- here is where we reference it
